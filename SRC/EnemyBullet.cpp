...
EnemyBullet::EnemyBullet() : GameObject("EnemyBullet"), mTimeToLive(2000)
{
}

/** Construct a new bullet with given position, velocity, acceleration, angle, rotation and lifespan. */
EnemyBullet::EnemyBullet(GLVector3f p, GLVector3f v, GLVector3f a, GLfloat h, GLfloat r, int ttl) : GameObject("AlienBullet", p, v, a, h, r), mTimeToLive(ttl)
{
}

/** Copy constructor. */
EnemyBullet::EnemyBullet(const EnemyBullet& b) : GameObject(b), mTimeToLive(b.mTimeToLive)
{
}
